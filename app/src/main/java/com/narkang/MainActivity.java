...
import com.chen.viewpager.CustomViewPager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvp_ = (CustomViewPager) findViewById(R.id.cvp_);
        cvp_.bindView(Arrays.asList(imageArray), new MyItemViewHandler());
    }
}
